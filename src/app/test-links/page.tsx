...
export default function TestLinksPage() {
  ...
  const generateTestLinks = () => {
    return selectedOrgs.map(orgId => {
      ...
      if (userName.trim()) {
        urlParams.append('name', userName.trim());
      }
      if (userEmail.trim()) {
        urlParams.append('email', userEmail.trim());
      }
      
      const queryString = urlParams.toString();
      const url = queryString 
        ? `${baseUrl}/test/${orgId}?${queryString}`
        : `${baseUrl}/test/${orgId}`;
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="p-6">
            ...
            <div className="mb-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
              <h3 className="font-semibold text-gray-900 mb-4">Tester Information</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="userEmail" className="block text-sm font-medium text-gray-700 mb-2">
                    Tester Email <span className="text-gray-400">(optional)</span>
                  </label>
                  <input
                    type="email"
                    id="userEmail"
              ...
              <p className="text-sm text-gray-600 mt-2">
                This information will be embedded in the test links and used for survey submissions.
              </p>
            </div>
            ...
            {/* Validation Warning */}
            {selectedOrgs.length > 0 && !userName.trim() && (
              <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div className="flex items-center">
                  ...
                  <p className="text-yellow-800 font-medium">
                    Please enter a tester name to generate personalized links.
                  </p>
                </div>
              </div>
            )}
            ...
            {testLinks.length > 0 && userName.trim() && (
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
